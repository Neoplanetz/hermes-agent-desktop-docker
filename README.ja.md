...
> 🔰 **Dockerは初めてですか？** [初心者ガイド](docs/GUIDE_FOR_BEGINNERS.ja.md)から始めましょう — 経験は不要です。
...
**[MIT ライセンス](LICENSE)** の下で配布されます。Hermes Agent 本体はビルド時に
ダウンロードされ、Nous Research の独自ライセンスに従います。
